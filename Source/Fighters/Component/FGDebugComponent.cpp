...
UFGDebugComponent::UFGDebugComponent()
{
...
void UFGDebugComponent::BeginPlay()
{
	Super::BeginPlay();
}

void UFGDebugComponent::SetManualDpiScaling(bool bEnableManualScaling)
{
	bUseManualDPIScaling = bEnableManualScaling;
}

void UFGDebugComponent::OverrideManualDpiScalingWindowSize(FVector2D OverrideWindowSize)
{
	WindowOriginalSize = OverrideWindowSize;
}

void UFGDebugComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
 ...
 */
void UFGDebugComponent::OpenAsWindow(
	UUserWidget* Widget,
	FString WindowTitle,
	...
	)
{
	...
	WindowClosedDelegate.BindUObject(this, &UFGDebugComponent::OnWindowClose);
 ...
 */
void UFGDebugComponent::OnWindowClose(const TSharedRef<SWindow>& EventWindow)
{
